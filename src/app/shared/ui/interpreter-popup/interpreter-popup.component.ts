    ...
    checkForNotification(showError, interpreter_id) {
        if (showError) {
            ...
            if (tmp.preference === 'preferred') {
                this.notificationServiceBus.launchNotification(true, 'Oops! This interpreter is already selected as a preferred interpreter. Please remove this interpreter first.');
            } else {
                this.notificationServiceBus.launchNotification(true, 'Oops! This interpreter is already selected as a blocked interpreter. Please remove this interpreter first');
            }
        }
    }
}
