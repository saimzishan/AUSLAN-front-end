...
export class BookingCreatingPage extends PageObject {
    /*
    ...
    didFinishedRendering = () => {
        ...
        this.cancleButton = this.getButtonByText('CANCEL');
        this.list_of_object = {};
        return browser.wait(protractor.ExpectedConditions.presenceOf(this.saveButton), 30000).then(() => {
            expect(this.saveButton).to.exist;
            expect(this.cancleButton).to.exist;
        });
    }
