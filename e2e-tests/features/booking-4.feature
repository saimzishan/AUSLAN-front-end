Feature: Booking Management
  ...
  @runThis
  Scenario: Given an Individual Client, Administrator should not get a popup when booking of two hours and needed interpreter 1 with business DSQ
  ...
  @runThis
  Scenario: Given an Individual Client, Administrator should get a popup when booking of three hours and needed interpreter 1 with business DSQ
    Given I exist as a Administrator
    Given The user 'Administrator' is of type dsq
    Given The user 'IndividualClient' is of type dsq
    And I sign in with valid Administrator credentials
    ...
    And I click on 'New Booking'
    Then I will be taken to the 'New Booking' form
    When I fill New Booking form fields correctly with standard time from 08:00 AM to 11:00 AM with 1 'auslanInterpreters_count'
    And I select the bookable for client
    Then I move to element name 'tnc'
    And I click on checkbox name 'tnc'
    When I click the create booking button
