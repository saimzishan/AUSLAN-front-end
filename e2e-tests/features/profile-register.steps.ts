...
//    Correctly fill in
    ...
    function fillAllDataForOrgRep(type: string) {
        ...
        page.getElementByName('email').sendKeys('george111@curvetomorrow.com.au');
        page.getElementByName('phone').sendKeys('0490394517');
        page.getElementByName('mobile').sendKeys('0490394517');
        ...
        // page.getElementByName('billingAddressIsDifferent_confirmation').click(); //  email on receipt
